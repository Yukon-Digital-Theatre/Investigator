export const scriptMeetTheWeaver =[
        ...
        {id:34, speaker:"weaver", text: "Oh I’m not sick, just, just little bits of fiber dust, gets in the lungs, especially during the actual weaving part. I’m, I’m sorry there’s not a comfortable…"},
        ...
        {id:44, speaker:"weaver", text: "Oh no, you’re far enough away that you shouldn’t breathe in too many bits of fiber. (coughs) I was fine for the first few months, it’s just after time, the lungs can get irritated. The eyes too, but for a quick talk we’ll both be fine. Now, your carpet! What type of carpet are you looking for?"},
    ...
    export const scriptGoingWithTheFlow =[
        ...
        {id:53, speaker:"weaver", text: "Oh, umm there’s a variety of different yarn, materials, I could use. Weavers call the material we weave with, yarn, not material. Although I suppose we call the raw fiber, material sometimes. Anyways, it really depends on how you want it to feel, and look. Also, your budget. As I – "},
        ...
        export const scriptDownToBusiness =[
            ...
            {id:5, speaker:"investigator", text:"Can you open up the window? I see what you mean about fiber dust"},
        ...
        export const scriptKeepGoing =[
            ...
            {id:6, speaker:"weaver", text:"I know, but it’s just yarn, some type of coarse yarn that’s definitely a mix of fibers, that’s as much as I can tell."},
        ...
        export const scriptNewTactic =[
            ...
            {id:4, speaker:"weaverbridge", text:"Well, well it’s definitely a mix. This, this is rough, so probably some type of poor quality wool, some plant or vegetable fiber too. Cotton is common. "},
            {id:5, speaker:"weaver", text: "Honestly, it’s probably a mix of the cheapest fibers they could find. It’s meant for office carpet, not palaces or other places people with money go. Seems to me anyways. (coughs)"},
            {id:6, speaker:"investigator", text:"You believe it’s just wool or plant fiber"},
            {id:7, speaker:"weaver", text:"I, I believe it’s wool and plant fiber as much as I can believe something I have no way of knowing. (coughs) Really, what I believe is that I don’t know, and frankly, don’t care what the yarn is made of."},
            ...
            {id:17, speaker:"weaver", text: "You said your last question was about the, the raw fiber in the yarn. I gave you a guess and answered several more questions too. I just really need to focus to get this done."},
            ...
            {id:55, speaker:"investigator", text:"Other fibers would strengthen it, you said it was mixed fibers, doesn’t that mean it’s possible"},
            {id:56, speaker:"weaver", text:"Fine, yes I admit if you mixed fibers, sure. (coughs) You could make a yarn that…well…"},
        ...
        export const scriptEndingTwo =[
            ...
            {id:10, speaker:"narrator", text:"The weaver leaves. You stand in the workroom, filled with fiber dust and carpets."},
        ...
        export const scriptEndingTwoB =[
            ...
            {id:9, speaker:"narrator", text:"You begin to choke on the fiber dust."},
